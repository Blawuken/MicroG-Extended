...
public class OpsiPengembang extends CollapsingToolbarBaseActivity {
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        Context applicationContext = getApplicationContext();
        setContentView(getResources("layout/uwu_layout_content"));
        getFragmentManager().beginTransaction().replace(R.id.uwu_content, new OpsiPengembangFragment()).commit();
    }
